...
<div class="feedback">
  ...
  <?php
  $sql1="select * from orderProducts where order_id='$orderId'";
  ...
  while($row1=mysqli_fetch_assoc($execute1)){
    ...
    echo "<div><img src='../womenFashionImages/".$ans['image1']."' style{width:50px height=100px}/>Feedback:
    <textarea type='text' rows='5' cols='50' name='$productid'></textarea></div><br>";
  }
     ?>
