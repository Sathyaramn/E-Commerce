...
<div class="flex-1">
          ...
          <div><a href="shopList.php">Shop List</a></div>
        ...
        <iframe src="userDetails.php" name="iframe_a" border=none height="600px" width="100%" title="Iframe Example"></iframe>
        </div>
  <div>
  </div>
 ...
 <div class="track-order" id="track-order">
   <table style="width:100%" class="track-order-table" id="track-order-table">
     ...
     <tr>
       ...
       <td>3455</td>
       <td>Delivered</td>
       <td><button type="submit">Click here</button></td>
     </tr>
     <tr>
       <td>2345</td>
       <td>Sathya</td>
